Ext.define(
				"core.kaoqinmanager.peoplemanage.view.AddPeopleForm",
				{
								...
								items : [
										{
											 ...
											 * { fieldLabel : '班组名称', xtype :
											 * "combobox", anchor : '-5', name :
											 * 'banzubh', queryMode :
											 * 'local',//因为上面的那个combobox已经把此处的store得到了，直接使用就好了
											 * store :
											 * "core.kaoqinmanager.peoplemanage.store.BanzuOptStore",
											 * loadingText : '正在加载数据，请稍侯……',
											 * triggerAction : 'all', valueField :
											 * 'banzubh', forceSelection : true,
											 * allowBlank : false,// 不允许为空
											 * displayField : 'banzuname',
											 * listeners:{ 'change':function(){
											 * var banzuname=this.rawValue; var
