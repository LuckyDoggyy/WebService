...
public class FlowTagController {
    ...
    public Map<String, Object> listTags() throws Exception {
        ...
        List<FlowTag> list = flowTagService.listFlowTags();
        map.put("rows", list);
    ...
    @ResponseBody
    public Map<String, Object> addTag(FlowTag tag) {
        Map<String, Object> map = new HashMap();
        if (flowTagService.insert(tag)) {
    ...
    @ResponseBody
    public Map<String, Object> updateTag(FlowTag tag) {
        Map<String, Object> map = new HashMap();
        if (flowTagService.update(tag)) {
            map.put("success", true);
            map.put("obj", "更新成功");
        } else {
            map.put("success", false);
