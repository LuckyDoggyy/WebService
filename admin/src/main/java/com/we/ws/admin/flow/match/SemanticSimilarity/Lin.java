...
// lin(1) specific senses for both words
        double linscore = lin.lin("fly", 1, "walk", 1, "n"); // "word1", sense#, "word2", sense#, "POS"
...
// max value (i.e. highest score!) : get the highest score for 2 words
		double maxvalue = lin.max("surfriding", "surfing", "v"); // "word1", "word2", "POS"
