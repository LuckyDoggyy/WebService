...
CREATE TABLE `T_Flow` (
  ...
  `tagId` int(11) NOT NULL DEFAULT '0' COMMENT '分类id',
...
-- ----------------------------
BEGIN;
INSERT INTO `T_FlowTag` VALUES ('1', '生活服务', '0', '0', '2017-07-11 19:36:24', '2017-07-12 11:16:05'), ('2', 'test-2', '0', '0', '2017-07-12 10:30:50', '2017-07-12 11:16:07');
COMMIT;
