...
public interface MobileCodeWSSoap {
    ...
    @RequestWrapper(localName = "getMobileCodeInfo", targetNamespace = "http://WebXml.com.cn/", className = "com.we.ws.service.client.mobile.GetMobileCodeInfo")
    @ResponseWrapper(localName = "getMobileCodeInfoResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.we.ws.service.client.mobile.GetMobileCodeInfoResponse")
    ...
    @ResponseWrapper(localName = "getDatabaseInfoResponse", targetNamespace = "http://WebXml.com.cn/", className = "com.we.ws.service.client.mobile.GetDatabaseInfoResponse")
    @WebResult(name = "getDatabaseInfoResult", targetNamespace = "http://WebXml.com.cn/")
    public com.we.ws.service.client.mobile.ArrayOfString getDatabaseInfo();
}
